      ...
      <div className="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden bg-[#BF202F] py-10 px-6 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 max-w-3xl text-base text-indigo-50">
                If you have any questions regarding your membership. Please fill out this contact form or give us a call.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">+1 (813) 542-0273</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">info@TheAppliancePlug.com</span>
                </dd>
              </dl>
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    type="submit"
                    className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-[#BF202F] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-[#BF202F]/80 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                  >
                    Submit
                  </button>
                </div>
